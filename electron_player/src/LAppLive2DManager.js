...
LAppLive2DManager.prototype.changeModel = function (gl) {
    ...
    if (this.reloadFlg) {
        ...
        var thisRef = this;
        this.models.length && this.models.forEach(val => val.release(gl))
        delete this.models[0] && (this.models[0] = new LAppModel()) && this.models[0].load(gl, LAppDefine.MODEL_SHIZUKU)
        /*
        switch (no) {
            case 0:
