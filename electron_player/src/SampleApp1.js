...
function mouseEvent(e) {
    ...
    if (e.type == "mousewheel") {
        ...
        const left = thisRef.canvas.offsetLeft
        const top = thisRef.canvas.offsetTop
        if (e.clientX < left || e.clientX > left + thisRef.canvas.width ||
            e.clientY < top || e.clentY > top + thisRef.canvas.height) {
            return;
        }
